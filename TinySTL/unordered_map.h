...
class unordered_map : public _HashTable<pair<Key, T>, Hash, KeyEqual, Alloc, true>
{
public:
    using key_type              = Key;
    using mapped_type           = T;
    ...
    using _Base                 = _HashTable<pair<Key, T>, Hash, KeyEqual, Alloc, true>;
...
template <typename Key, typename T,
    ...
    typename KeyEqual = equal_to<Key>,
    typename Alloc = allocator<pair<Key, T>>>
class unordered_multimap : public _HashTable<pair<Key, T>, Hash, KeyEqual, Alloc, true>
{
public:
    using key_type              = Key;
    using mapped_type           = T;
