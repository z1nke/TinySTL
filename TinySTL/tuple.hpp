...
public:
    ...
    template <typename H, typename... T, enable_if_t<                   // (4)
        is_constructible<Head, const H&>::value
        && sizeof...(Tail) == sizeof...(T), 
        int> = 0>
...
constexpr tuple_element_t<Idx, tuple<Ts...>>&
get(tuple<Ts...>& t) noexcept
{
    using TupleType = typename 
        tuple_element<Idx, tuple<Ts...>>::TupleType;
