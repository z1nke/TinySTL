...
void testMemory() 
{
    std::string str = "abcd";
    char buffer[5];
    tiny_stl::uninitialized_copy(str.c_str(), str.c_str() + str.size() + 1, buffer);
    ...
    tiny_stl::unique_ptr<int, void(*)(int*)> up3(new int[10], [](int* p) {delete[] p; });
...
void testAlgorithm() 
{
    ...
    UNIT_TEST(true, (--v1.end()) == tiny_stl::is_sorted_until(v1.begin(), v1.end()));
...
void testArray() 
{
    ...
    i = 1;
    for (auto riter = re_arr1.rbegin(); 
        riter != re_arr1.rend(); ++riter) 
    {
        UNIT_TEST(i, *riter);
        ++i;
    }
    ...
    UNIT_TEST(true, (tiny_stl::is_same_v<
        tiny_stl::tuple_element_t<0, decltype(arr2)>, 
        std::int32_t>));
...
void testVector()
{
    ...
    tiny_stl::vector<tiny_stl::vector<int>> v12 = { {1,2,3,4},{2,3,4,5},{3,4,5,6} };
...
void testForwardList() 
{
    ...
    tiny_stl::forward_list<int> fl11 = { 1,2,3,3,3,4,2,6,6,7,2,3,4,8,8 };
    fl11.unique();
    //print_elements(fl11);
    fl11.sort();
...
void testRBTree()
{
    //tiny_stl::_RBTree<int, tiny_stl::less<int>, tiny_stl::allocator<int>, false> tree;
...
void testMap()
{
    tiny_stl::map<int, double> m{ {2,2.2}, {3,3.3}, {6,6.6}, {4,4.4}, {3,3.3}, {0, 0.0},{1,1.1} };
    ...
    tiny_stl::multimap<int, double>
        mm{ { 2,2.2 },{ 3,3.3 },{ 6,6.6 },{ 4,4.4 },{ 3,3.3 },{ 0, 0.0 },{ 1,1.1 } };
...
{
    tiny_stl::unordered_map<int, double> 
        um{ { 2,2.2 },{ 3,3.3 },{ 6,6.6 },{ 4,4.4 },{ 3,3.3 },{ 0, 0.0 },{ 1,1.1 } };
    ...
    tiny_stl::unordered_multimap<int, double>
        umm{ { 2,2.2 },{ 3,3.3 },{ 6,6.6 },{ 4,4.4 },{ 3,3.3 },{ 0, 0.0 },{ 1,1.1 } };
